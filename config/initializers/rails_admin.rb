...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Allworld', 'Admin']
  ...
  config.audit_with :history, 'Category'
  config.audit_with :history, 'Group'
  config.audit_with :history, 'Region'
  config.audit_with :history, 'Section'
  config.audit_with :history, 'Tag'
  ...
  config.model 'Linkobjtocount' do
    navigation_label I18n.t('menu.system')
  end
  config.model 'Placevidel' do
    navigation_label I18n.t('menu.system')
  end
  config.model 'Placenet' do
    navigation_label I18n.t('menu.system')
  end
